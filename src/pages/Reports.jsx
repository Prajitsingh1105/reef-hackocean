...
export default function Reports() {
  return (
    <div className="p-margin-desktop grid grid-cols-1 gap-6 w-full max-w-container-max mx-auto h-full flex-col">
      <style>{`
        .glass-panel {
          ...
          <div className="space-y-6 flex-1 relative z-10 overflow-y-auto pr-2">
            ...
            <div>
              ...
              <div className="h-32 bg-surface-container-high/50 border border-outline-variant/30 rounded flex items-end p-2 gap-1">
                ...
                <div className="w-full bg-secondary-container/40 h-[30%] rounded-t hover:bg-secondary-container transition-colors relative group"><div class="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] hidden group-hover:block bg-background px-1 rounded border border-outline-variant">9</div></div>
                <div className="w-full bg-secondary-container/40 h-[80%] rounded-t hover:bg-secondary-container transition-colors relative group"><div class="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] hidden group-hover:block bg-background px-1 rounded border border-outline-variant">24</div></div>
                <div className="w-full bg-secondary-container/40 h-[50%] rounded-t hover:bg-secondary-container transition-colors relative group"><div class="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] hidden group-hover:block bg-background px-1 rounded border border-outline-variant">15</div></div>
                <div className="w-full bg-secondary-container/40 h-[90%] rounded-t hover:bg-secondary-container transition-colors relative group"><div class="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] hidden group-hover:block bg-background px-1 rounded border border-outline-variant">27</div></div>
                <div className="w-full bg-secondary-container h-[100%] rounded-t shadow-[0_0_10px_rgba(0,241,254,0.5)] relative group"><div class="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] hidden group-hover:block bg-background px-1 rounded border border-secondary-container text-secondary-container">37</div></div>
              </div>
            </div>
