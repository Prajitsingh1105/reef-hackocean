...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center px-margin-desktop w-full fixed top-0 right-0 md:left-72 md:w-[calc(100%-18rem)] h-20 bg-background/80 text-on-surface border-b border-outline-variant/20 backdrop-blur-md z-40">
      <div>
        <h2 className="font-headline-md text-headline-md font-bold tracking-tight">{info.title}</h2>
        <p className="font-body-md text-body-md text-on-surface-variant">{info.subtitle}</p>
      </div>
